...
chap = Roster::Chapter.create name: 'Chicago'
county = Roster::County.create name: 'Cook', chapter: chap
role = Roster::Role.create name: 'admin', grant_name: 'incidents_admin', chapter_id: 1
pos = Roster::Position.create name: 'admin', watchfire_role: 'yes', abbrev: 'admin', chapter_id: 1
person = Roster::Person.create chapter_id: 1, primary_county_id:1, first_name: "John", last_name: "Smith", username: "john", password: "smith", home_phone: "1112223333", cell_phone: "1112223333", work_phone: "1112223333", address1: "10 10th St", city: "Chicago", state: "IL", zip: "60660"
